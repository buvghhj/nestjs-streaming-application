...
import { FindChatMessageByStreamQuery, FindSponsorByChannelQuery } from "@/graphql/gennerated/output"
import { stringToColor } from "@/utils/color"
import { Medal } from "lucide-react"

interface MessageItemProps {
    message: FindChatMessageByStreamQuery['findChatMessageByStream'][0]
    isSponsor: boolean
}
