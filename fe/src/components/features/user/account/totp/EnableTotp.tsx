...
import { useEnableTotpMutation, useGenerateTotpSecretQuery } from "@/graphql/gennerated/output"
                    ...
                    <Form {...form}>
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-4">
                            ...
                            <DialogFooter>
                                ...
                                <Button type='submit' disabled={!isValid || isLoadingGenerate || isLoadingEnable}>{t('submitButton')}</Button>
