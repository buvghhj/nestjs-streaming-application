...
import { useFindCurrentSessionQuery, useFindSessionByUserQuery } from "@/graphql/gennerated/output"
...
const SessionList = () => {
    ...
    const { data: sessionsData, loading: isLoadingSession } = useFindSessionByUserQuery()
