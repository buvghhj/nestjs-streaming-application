...
import { FindChannelByUsernameQuery, useChangStreamInfoMutation, useFindAllCategoriesQuery } from "@/graphql/gennerated/output"
import { changeStreamInfoSchema, TypeChangeStreamInfoSchema } from "@/schemas/stream/change-stream-info.schema"
...
const ChangeStreamInfo = ({ stream }: ChangeStreamInfoProps) => {
    ...
    const [update, { loading: isLoadingUpdate }] = useChangStreamInfoMutation({
    ...
    const onSubmit = (data: TypeChangeStreamInfoSchema) => {
